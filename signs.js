...
const SIGNS = [
  ...
  { code: "A9a", cat: "danger", meaning: "Traversée de voie de transport en commun (danger)", file: "France Road Sign A9a.png" },
  { code: "A9b", cat: "danger", meaning: "Traversée de voies de tramway (danger)", file: "France road sign A9.svg" },
  ...
  { code: "B3a", cat: "interdiction", meaning: "L'interdiction de dépasser concerne seulement les transport de marchandises de plus de 3,5 tonnes" },
  ...
  { code: "B25", cat: "obligation", meaning: "Vitesse minimale obligatoire", file: "France road sign B25 (30).svg" },
  ...
  { code: "B34a", cat: "fin", meaning: "Fin d'interdiction de dépasser pour les véhicules de transport de marchandises de plus de 3,5 tonnes" },
  ...
  { code: "B51", cat: "zone", meaning: "Sortie d'une zone à vitesse limitée à 30 km/h", file: "France road sign B51 (30).svg" },
  ...
  { code: "C20a", cat: "indication", meaning: "Passage pour piétons (indication)" },
  { code: "C20b", cat: "indication", meaning: "Traversée de voie de transport en commun (indication)" },
  { code: "C20c", cat: "indication", meaning: "Traversée de voies de tramway (indication)" },
